...
# Used to sort pages by "date", "update_date", "title", "title_bytes", "weight", or "none", for pagination. See below for more information.
sort_by = "none"
...
{{figure(src="/pages/about/test.png", style="width: 25%;", position="left", caption_position="left", caption="tuxedo cat", caption_style="font-weight: bold; font-style: italic;")}}
{{figure(src="pages/about/test.png", style="width: 25%;", position="left", caption_position="left", caption="tuxedo cat", caption_style="font-weight: bold; font-style: italic;")}}
{{figure(src="../pages/about/test.png", style="width: 25%;", position="left", caption_position="left", caption="tuxedo cat", caption_style="font-weight: bold; font-style: italic;")}}
